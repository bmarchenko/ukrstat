...
AmCharts.AmChart = AmCharts.Class({
    ...
    initChart: function () {
        ...
        if (b && window.getComputedStyle && (b = window.getComputedStyle(b))) this.dmouseY = AmCharts.removePx(b.getPropertyValue("margin-top")), this.dmouseX = AmCharts.removePx(b.getPropertyValue("margin-left"));
        this.mouseMode = a;
...
AmCharts.Cuboid = AmCharts.Class({
    ...
    draw: function () {
        ...
        var r, u, t, v, x, y, w, A, B;
        if (0 < f || 0 < g) w = q, q = AmCharts.adjustLuminosity(p, -0.2), q = AmCharts.adjustLuminosity(p, -0.2), r = AmCharts.polygon(b, [0, f, d + f, d, 0], [0, g, g, 0, 0], q, j, 0, 0, 0, n), 0 < m && (B = AmCharts.line(b, [0, f, d + f], [0, g, g], l, m, k)), u = AmCharts.polygon(b, [0, 0, d, d, 0], [0, e, e, 0, 0], q, j, 0, 0, 0, 0, n), u.translate(f, g), 0 < m && (t = AmCharts.line(b, [f, f], [g, g + e], l, 1, k)), v = AmCharts.polygon(b, [0, 0, f, f, 0], [0, e, e + g, g, 0], q, j, 0, 0, 0, n), x = AmCharts.polygon(b, [d, d, d + f, d + f, d], [0, e, e + g, g, 0], q, j, 0, 0, 0, n), 0 < m && (y = AmCharts.line(b, [d, d + f, d + f, d], [0, g, e + g, e], l, m, k)), q = AmCharts.adjustLuminosity(w, 0.2), w = AmCharts.polygon(b, [0, f, d + f, d, 0], [e, e + g, e + g, e, e], q, j, 0, 0, 0, n), 0 < m && (A = AmCharts.line(b, [0, f, d + f], [e, e + g, e + g], l, m, k));
        1 > Math.abs(e) && (e = 0);
        1 > Math.abs(d) && (d = 0);
        ...
        e = 0 > e ? [r, B, u, t, v, x, y, w, A, b] : [w, A, u, t, v, x, r, B, y, b];
...
AmCharts.AmLegend = AmCharts.Class({
    ...
    arrangeEntries: function () {
        ...
        for (v = 0; v < u.length; v++) {
            var A = u[v];
            this.reversedOrder && (A = u[u.length - v - 1]);
            t = A.getBBox();
            var B;
            this.equalWidths ? B = g + y * (s + m + this.markerLabelGap) : (B = w, w = w + t.width + g + m);
            B + t.width > n && 0 < v && (x++, y = 0, B = g, w = B + t.width + g + m);
            A.translate(B, (p + l) * x);
            y++;
            !isNaN(k) && y >= k && (y = 0, x++);
            q.push(A)
        ...
        d.toBack();
        b = g;
        if ("top" == a || "bottom" == a || "absolute" == a) "center" == this.align ? b = g + (j - t.width) / 2 : "right" == this.align && (b = g + j - t.width);
        q.translate(b, l + 1);
    ...
    createEntry: function (a) {
        if (!1 !== a.visibleInLegend) {
            ...
            var m;
            e && (m = AmCharts.text(this.container, e, h, b.fontFamily, j, "start"), m.translate(this.lx, this.ly), f.push(m), b = m.getBBox().width, this.maxLabelWidth < b && (this.maxLabelWidth = b));
    ...
    parseSerialData: function () {
        ...
        if (f) {
            ...
            for (l = 0; l < f.length; l++) {
                ...
                m.category = String(b);
                k[n[e]] = m;
                g && (b = isNaN(b) ? new Date(b.getFullYear(), b.getMonth(), b.getDate(), b.getHours(), b.getMinutes(), b.getSeconds(), b.getMilliseconds()) : new Date(b), b = AmCharts.resetDateToMin(b, h, j), m.category = b, m.time = b.getTime());
        ...
        for (d = 0; d < a.length; d++) b = a[d], b.dataProvider && this.parseGraphData(b)
    },
            ...
            if (!isNaN(this.min) && !isNaN(this.max) && this.foundGraphs && Infinity != this.min && -Infinity != this.max) {
                ...
                if (0 < x) {
                    ...
                    for (e = this.fillAlpha = 0; e < x; e++) {
                        var w = v[e],
                            A = NaN;
                        isNaN(w.toValue) || (A = this.getCoordinate(w.toValue), t = new this.axisItemRenderer(this, A, "", !0, NaN, NaN, w), this.pushAxisItem(t));
                        var B = NaN;
                        isNaN(w.value) || (B = this.getCoordinate(w.value), t = new this.axisItemRenderer(this, B, w.label, !0, NaN, (A - B) / 2, w), this.pushAxisItem(t));
                        isNaN(A - B) || (t = new this.guideFillRenderer(this, B, A, w), this.pushAxisItem(t), t = t.graphics(), w.graphics = t, w.balloonText && this.addEventListeners(t, w))
                    }
                    this.fillAlpha = y
                }
                v = !1;
                for (e = p; e < q; e += s) t = AmCharts.roundTo(this.step * e + this.min, d), -1 != String(t).indexOf("e") && (v = !0, String(t).split("e"));
                ...
                for (e = p; e < q; e += s) if (p = this.step * e + this.min, p = AmCharts.roundTo(p, this.maxDecCount + 1), !(this.integersOnly && Math.round(p) != p)) {
                    ...
                    if (p == this.baseValue && "radar" != k) {
                        var I, G, x = this.viW,
                            ...
                            p = this.viX;
                        t = this.viY;
                        "H" == this.orientation ? 0 <= d && d <= x + 1 && (I = [d, d, d + f], G = [y, 0, g]) : 0 <= d && d <= y + 1 && (I = [0, x, x + f], G = [d, d, d + g]);
                        I && (d = AmCharts.fitToBounds(2 * this.gridAlpha, 0, 1), d = AmCharts.line(a.container, I, G, this.gridColor, d, 1, this.dashLength), d.translate(p, t), this.grid0 = d, a.axesSet.push(d), d.toBack())
                    }
                }
                e = this.baseValue;
    ...
    stackGraphs: function (a) {
        ...
        for (n = this.start; n <= this.end; n++) {
            ...
            for (m = 0; m < j.length; m++) if (l = j[m], !l.hidden && (k = l.type, l.chart == this.chart && (l.valueAxis == this && a == k && l.stackable) && (k = this.data[n].axes[this.id].graphs[l.id], h = k.values.value, !isNaN(h)))) {
                ...
                g[n] = AmCharts.roundTo(g[n], p);
                l = l.fillToGraph;
                linetype && l && (k.values.open = this.data[n].axes[this.id].graphs[l.id].values.value);
                "regular" == b && (linetype && (isNaN(d[n]) ? (d[n] = h, k.values.close = h, k.values.open = this.baseValue) : (k.values.close = isNaN(h) ? d[n] : h + d[n],
                    k.values.open = d[n], d[n] = k.values.close)), "column" == a && !isNaN(h) && (k.values.close = h, 0 > h ? (k.values.close = h, isNaN(e[n]) ? k.values.open = s : (k.values.close += e[n], k.values.open = e[n]), e[n] = k.values.close) : (k.values.close = h, isNaN(f[n]) ? k.values.open = s : (k.values.close += f[n], k.values.open = f[n]), f[n] = k.values.close)))
            }
        }
        for (n = this.start; n <= this.end; n++) for (m = 0; m < j.length; m++) l = j[m], l.hidden || (k = l.type, l.chart == this.chart && (l.valueAxis == this && a == k && l.stackable) && (k = this.data[n].axes[this.id].graphs[l.id], h = k.values.value,
            isNaN(h) || (d = 100 * (h / g[n]), k.values.percents = d, k.values.total = g[n], "100%" == b && (isNaN(e[n]) && (e[n] = 0), isNaN(f[n]) && (f[n] = 0), 0 > d ? (k.values.close = AmCharts.fitToBounds(d + e[n], -100, 100), k.values.open = e[n], e[n] = k.values.close) : (k.values.close = AmCharts.fitToBounds(d + f[n], -100, 100), k.values.open = f[n], f[n] = k.values.close)))))
    },
...
AmCharts.CategoryAxis = AmCharts.Class({
    ...
    draw: function () {
        ...
        if (AmCharts.ifArray(a)) {
            ...
            for (b = 0; b < j; b++) k = this.guides[b], h = h = h = t = e = NaN, k.toCategory && (h = d.getCategoryIndexByValue(k.toCategory), isNaN(h) || (e = this.getCoordinate(h - g), l = new this.axisItemRenderer(this, e, "", !0, NaN, NaN, k), this.pushAxisItem(l))), k.category && (h = d.getCategoryIndexByValue(k.category),
                isNaN(h) || (t = this.getCoordinate(h - g), h = (e - t) / 2, l = new this.axisItemRenderer(this, t, k.label, !0, NaN, h, k), this.pushAxisItem(l))), k.toDate && (this.equalSpacing ? (h = d.getClosestIndex(this.data, "time", k.toDate.getTime(), !1, 0, this.data.length - 1), isNaN(h) || (e = this.getCoordinate(h - g))) : e = (k.toDate.getTime() - this.startTime) * this.stepWidth, l = new this.axisItemRenderer(this, e, "", !0, NaN, NaN, k), this.pushAxisItem(l)), k.date && (this.equalSpacing ? (h = d.getClosestIndex(this.data, "time", k.date.getTime(), !1, 0, this.data.length - 1), isNaN(h) || (t = this.getCoordinate(h - g))) : t = (k.date.getTime() - this.startTime) * this.stepWidth, h = (e - t) / 2, l = "H" == this.orientation ? new this.axisItemRenderer(this, t, k.label, !1, 2 * h, NaN, k) : new this.axisItemRenderer(this, t, k.label, !1, NaN, h, k), this.pushAxisItem(l)), e = new this.guideFillRenderer(this, t, e, k), t = e.graphics(), this.pushAxisItem(e), k.graphics = t, t.index = b, k.balloonText && this.addEventListeners(t, k)
        }
        this.axisCreated = !0;
        d = this.x;
        g = this.y;
    ...
    timeZoom: function (a,
        ...
        this.startTime = a;
        this.endTime = b;
        var d = this.minDuration();
        this.endTime = 6048E5 > Number(d) ? b + d : b + 864E5
    },
    ...
    xToIndex: function (a) {
        ...
        0 > g && d++;
        return d = AmCharts.fitToBounds(d,
            0, b.length - 1)
    },
...
AmCharts.RecItem = AmCharts.Class({
    construct: function (a, b, d, e, f, g, h, j, k) {
        ...
        "V" == ea && (G = 0);
        var W;
        I && (W = AmCharts.text(s, d, n, l, m, V, j),
            ga = W.getBBox().width);
        if ("H" == ea) {
            if (0 <= b && b <= ba + 1 && (0 < t && (0 < u && b + k <= ba + 1) && (ma = AmCharts.line(s, [b + k, b + k], [0, t], r, u, x), p.push(ma)), 0 < v && (V = AmCharts.line(s, [b, b + T, b + T], [fa, fa + S, S], y, v, x, w), p.push(V))), E = 0, F = b, h && 90 == G && (F -= m), !1 === e ? (V = "start", E = "bottom" == N ? Q ? E + t : E - t : Q ? E - t : E + t, F += 3, f && (F += f / 2, V = "middle"), 0 < G && (V = "middle")) : V = "middle", 1 == Y && (0 < B && !h && U < ba) && (e = AmCharts.fitToBounds(b, 0, ba), U = AmCharts.fitToBounds(U, 0, ba), $ = e - U, 0 < $ && (fill = AmCharts.rect(s, $, a.height, A, B), fill.translate(e - $ + T, S), p.push(fill))),
                "bottom" == N ? (E += fa + m / 2 + ca, Q ? 0 < G ? (E = fa - ga / 2 * Math.sin(O) - t - 3, F += ga / 2 * Math.cos(O)) : E -= t + m + 3 + 3 : 0 < G ? (E = fa + ga / 2 * Math.sin(O) + t + 3, F -= ga / 2 * Math.cos(O)) : E += t + q + 3 + 3) : (E += S + m / 2 - ca, F += T, Q ? 0 < G ? (E = ga / 2 * Math.sin(O) + t + 3, F -= ga / 2 * Math.cos(O)) : E += t + 3 : 0 < G ? (E = -(ga / 2) * Math.sin(O) - t - 6, F += ga / 2 * Math.cos(O)) : E -= t + m + 3 + q + 3), "bottom" == N ? $ = (Q ? fa - t - 1 : fa + q - 1) + ca : (z = T, $ = (Q ? S : S - t - q + 1) - ca), g && (F += g), S = F, 0 < G && (S += ga / 2 * Math.cos(O)), W && (N = 0, Q && (N = ga / 2 * Math.cos(O)), S + N > ba + 1 || 0 > S)) W.remove(), W = null
        } else {
            0 <= b && b <= fa + 1 && (0 < t && (0 < u && b + k <= fa + 1) && (ma = AmCharts.line(s, [0, t], [b + k, b + k], r, u, x), p.push(ma)), 0 < v && (V = AmCharts.line(s, [0, T, ba + T], [b, b + S, b + S], y, v, x, w), p.push(V)));
            V = "end";
            if (!0 === Q && "left" == N || !1 === Q && "right" == N) V = "start";
            E = b - m / 2;
            1 == Y && (0 < B && !h) && (e = AmCharts.fitToBounds(b, 0, fa), U = AmCharts.fitToBounds(U, 0, fa), O = e - U, fill = AmCharts.polygon(s, [0, a.width, a.width, 0], [0, 0, O, O], A, B), fill.translate(T, e - O + S), p.push(fill));
            E += m / 2;
            "right" == N ? (F += T + ba + ca, E += S, Q ? (F -= t + 4, g || (E -= m / 2 + 3)) : (F += t + 4 + q, E -= 2)) : Q ? (F += t + 4 - ca, g || (E -= m / 2 + 3), h && (F += T, E += S)) : (F += -t - q - 4 - 2 - ca, E -= 2);
            ma && ("right" == N ? (z += T + ca + ba, $ += S, z = Q ? z - q : z + q) : (z -= ca, Q || (z -= t + q)));
            g && (E += g);
            Q = -3;
            "right" == N && (Q += S);
            if (W && (E > fa + 1 || E < Q)) W.remove(), W = null
        }
        ma && ma.translate(z, $);
        !1 === a.visible && (ma && ma.remove(), W && (W.remove(), W = null));
        W && (W.attr({
            "text-anchor": V
        }), W.translate(F, E), 0 !== G && W.rotate(-G), a.allLabels.push(W), " " != d && (this.label = W));
        a.counter = 0 === Y ? 1 : 0;
        a.previousCoord = b;
        ...
        if (b) {
            ...
            for (p = 0; p < s; p++) {
                var q = 180 - 360 / s * p,
                    ...
                    r = AmCharts.line(b.container, [g, r], [h, u], e, f, d);
                this.set.push(r);
                if (k) {
                    var t = "start",
...
AmCharts.RadItem = AmCharts.Class({
    construct: function (a, b, d, e, f, g, h) {
        ...
        g = a.x;
        var G = a.y;
        h ? (y = !0, isNaN(h.tickLength) || (p = h.tickLength), void 0 != h.lineColor && (u = h.lineColor), isNaN(h.lineAlpha) || (q = h.lineAlpha), isNaN(h.dashLength) || (t = h.dashLength), isNaN(h.lineThickness) || (r = h.lineThickness), !0 === h.inside && (w = !0)) : d || (q /= 3, p /= 2);
        var Y = "end",
            Q = -1;
        w && (Y = "start", Q = 1);
        var T;
        y && (T = AmCharts.text(m, d, l, j, k, Y), T.translate(g + (p + 3) * Q, b), e.push(T), this.label = T, I = AmCharts.line(m, [g, g + p * Q], [b, b], n, s, r), e.push(I));
        b = a.y - b;
        d = [];
        j = [];
        if ("polygons" == A) {
            B = a.data.length;
            for (k = 0; k < B; k++) l = 180 - 360 / B * k, d.push(b * Math.sin(l / 180 * Math.PI)),
        ...
        if (1 == f && 0 < x && !h) {
            h = a.previousCoord;
            if ("polygons" == A) {
                for (k = B; 0 <= k; k--) l = 180 - 360 / B * k, d.push(h * Math.sin(l / 180 * Math.PI)), j.push(h * Math.cos(l / 180 * Math.PI));
                B = AmCharts.polygon(m, d, j, v, x)
            } else B = AmCharts.wedge(m, 0, 0, 0, -360, b, b, h, 0, {
                fill: v,
                "fill-opacity": x,
                stroke: 0,
                "stroke-opacity": 0,
    ...
    construct: function (a, b, d, e) {
        ...
        if ("polygons" == a.gridType) {
            ...
            var k = [],
                l = a.data.length,
                m;
            for (m = 0; m < l; m++) j = 180 - 360 / l * m, e.push(f * Math.sin(j / 180 * Math.PI)), k.push(f * Math.cos(j / 180 * Math.PI));
            e.push(e[0]);
            k.push(k[0]);
...
AmCharts.AmGraph = AmCharts.Class({
    ...
    createSerialGraph: function () {
        var a = this.id,
            ...
            q = [],
            r = [],
            u, t, v = this.chart.graphs.length,
            x, y = this.dx / this.depthCount,
            w = this.dy / this.depthCount,
            A = f.stackType,
        ...
        if (!Y && ("line" == g || "smoothedLine" == g || "step" == g)) if (1 == d.length && ("step" != g && "none" == this.bullet) && (this.bullet = "round",
            this.resetBullet = !0), Ea || void 0 != ya) {
            var za = S;
            za > f.max && (za = f.max);
            za < f.min && (za = f.min);
            ...
            m ? (W = k, Xa = Math.abs(nb - ta), Za = k, $a = Math.abs(Qa - ta), Pa = Ya = 0, f.reversed ? (Na = 0, Oa = ta) : (Na = ta, Oa = 0)) : (Xa = j, W = Math.abs(nb - ta), $a = j, Za = Math.abs(Qa - ta), Oa = Na = 0, f.reversed ? (Pa = l, Ya = ta) : Pa = ta + 1)
        }
        var ua = Math.round;
        this.pmx = ua(Na);
        this.pmy = ua(Ya);
        ...
        this.nmh = ua(Za);
        this.nmw = ua($a);
        h = "column" == g ? ($ * h - O * (n - 1)) / n : $ * h;
        1 > h && (h = 1);
        var L;
        if ("line" == g || "step" == g || "smoothedLine" == g) {
            if (0 < I) for (L = I - 1; - 1 < L; L--) if (E = d[L], z = E.axes[f.id].graphs[a], ga = z.values.value) {
                I = L;
                break
            }
            if (G < d.length - 1) for (L = G + 1; L < d.length; L++) if (E = d[L], z = E.axes[f.id].graphs[a], ga = z.values.value) {
                G = L;
                break
            }
        }
        ...
        var ha = [],
            ia = [],
            Ha = !1;
        if ("line" == g || "step" == g || "smoothedLine" == g) if (this.stackable && "regular" == A || "100%" == A || this.fillToGraph) Ha = !0;
        for (L = I; L <= G; L++) {
            E = d[L];
            z = E.axes[f.id].graphs[a];
            z.index = L;
            var J, K, H, Z, pa = NaN,
                D = NaN,
                C = NaN,
                ...
                na = fa,
                la, oa;
            void 0 != z.color && (va = z.color);
            z.fillColors && (va = z.fillColors);
            isNaN(z.alpha) || (Ia = z.alpha);
            var sa = z.values;
            f.recalculateToPercents && (sa = z.percents);
            if (sa) {
                R = !this.stackable || "none" == A || "3d" == A ? sa.value : sa.close;
                if ("candlestick" == g || "ohlc" == g) R = sa.close, Ua = sa.low, Aa = f.getCoordinate(Ua), Ta = sa.high, Ba = f.getCoordinate(Ta);
                ja = sa.open;
                C = f.getCoordinate(R);
                ...
                var pa = E.x[Q.id],
                    wa = Math.floor($ / 2),
                    Ja = wa;
                "start" == this.pointPosition && (pa -= $ / 2, wa = 0, Ja = $);
                Y || (z.x = pa); - 1E5 > pa && (pa = -1E5);
                pa > j + 1E5 && (pa = j + 1E5);
                m ? (D = C, P = M, M = C = pa, isNaN(ja) && !this.fillToGraph && (P = T), Ra = Aa, Sa = Ba) : (P = D = pa, isNaN(ja) && !this.fillToGraph && (M = T));
                switch (g) {
                    case "line":
                        isNaN(R) ? p || (this.drawLineGraph(q, r, ha, ia), q = [], r = [], ha = [], ia = []) : (z.isNegative = R < S ? !0 : !1, q.push(D), r.push(C), X = D, aa = C, qa = D, ra = C, Ha && (!isNaN(M) && !isNaN(P)) && (ha.push(P), ia.push(M)));
                        break;
                    case "smoothedLine":
                        isNaN(R) ? p || (this.drawSmoothedGraph(q, r, ha, ia), q = [], r = [], ha = [], ia = []) : (z.isNegative = R < S ? !0 : !1, q.push(D), r.push(C), X = D, aa = C, qa = D, ra = C, Ha && (!isNaN(M) && !isNaN(P)) && (ha.push(P), ia.push(M)));
                        break;
                    case "step":
                        isNaN(R) ? p || (t = NaN, this.drawLineGraph(q, r, ha, ia), q = [], r = [], ha = [], ia = []) : (z.isNegative = R < S ? !0 : !1, m ? (isNaN(u) || (q.push(u), r.push(C - wa)), r.push(C - wa), q.push(D),
                            r.push(C + Ja), q.push(D), Ha && (!isNaN(M) && !isNaN(P)) && (ha.push(P), ia.push(M - wa), ha.push(P), ia.push(M + Ja))) : (isNaN(t) || (r.push(t), q.push(D - wa)), q.push(D - wa), r.push(C), q.push(D + Ja), r.push(C), Ha && (!isNaN(M) && !isNaN(P)) && (ha.push(P - wa), ia.push(M), ha.push(P + Ja), ia.push(M))), u = D, t = C, X = D, aa = C, qa = D, ra = C);
                        break;
                    case "column":
                        la = na;
                        void 0 != z.lineColor && (la = z.lineColor);
                        if (!isNaN(R)) {
                            R < S ? (z.isNegative = !0, Ea && (va = Ea), void 0 != ya && (na = ya)) : z.isNegative = !1;
                            var ob = f.min,
                                pb = f.max;
                            if (!(R < ob && (ja < ob || void 0 == ja) || R > pb && ja > pb)) if (m) {
                                "3d" == A ? (K = C - 0.5 * (h + O) + O / 2 + w * ea, J = P + y * ea) : (K = C - (n / 2 - ea) * (h + O) + O / 2, J = P);
                                H = h;
                                X = D;
                                aa = K + h / 2;
                                qa = D;
                                ...
                                if (K < k && 0 < H && (ka = new AmCharts.Cuboid(e, Z, H, y, w, va, Ia, N, la, U, V, s, m), "bottom" != B)) if (B = f.reversed ? "left" : "right", 0 > R) B = f.reversed ? "right" : "left";
                                else if ("regular" == A || "100%" == A) X += this.dx
                            } else {
                                "3d" == A ? (J = D - 0.5 * (h + O) + O / 2 + y * ea, K = M + w * ea) : (J = D - (n / 2 - ea) * (h + O) + O / 2, K = M);
                                H = h;
                                X = J + h / 2;
                                aa = C;
                                qa = J + h / 2;
                                ...
                                if (J < j + ea * y && 0 < H) if (ka = new AmCharts.Cuboid(e, H, Z, y, w, va, Ia, N, la, this.lineAlpha, V, s, m), 0 > R && "middle" != B) B = "bottom";
                                else if (B = ma, "regular" == A || "100%" == A) aa += this.dy
                            }
                            if (ka) {
                                oa = ka.set;
                                oa.translate(J, K);
                                this.columnsSet.push(oa);
                                z.url && oa.setAttr("cursor", "pointer");
                                if (!Y) {
                                    "none" == A && (x = m ? (this.end + 1 - L) * v - b : v * L + b);
                                    "3d" == A && (m ? (x = (v - b) * (this.end + 1 - L), X += y * this.columnIndex, qa += y * this.columnIndex, z.y += y * this.columnIndex) : (x = (v - b) * (L + 1), X += 3, aa += w * this.columnIndex + 7, ra += w * this.columnIndex, z.y += w * this.columnIndex));
                                    if ("regular" == A || "100%" == A) B = "middle", x = m ? 0 < sa.value ? (this.end + 1 - L) * v + b : (this.end + 1 - L) * v - b : 0 < sa.value ? v * L + b : v * L - b;
                                    ...
                                    this.animateColumns(ka, L, D, P, C, M);
                                    this.addListeners(oa, z)
                                }
                                z.columnSprite = oa
                            }
                        }
                    ...
                    case "candlestick":
                        if (!isNaN(ja) && !isNaN(Ta) && !isNaN(Ua) && !isNaN(R)) {
                            var Va, ab;
                            R < ja && (z.isNegative = !0, Ea && (va = Ea), Ga && (Ia = Ga), void 0 != ya && (na = ya));
                            la = na;
                            void 0 != z.lineColor && (la = z.lineColor);
                            if (m) {
                                if (K = C - h / 2, J = P, H = h, K + H > k && (H = k - K), 0 > K && (H += K, K = 0), K < k && 0 < H) {
                                    var bb, cb;
                                    R > ja ? (bb = [D, Sa], cb = [P, Ra]) : (bb = [P, Sa], cb = [D, Ra]);
                                    C < k && 0 < C && (Va = AmCharts.line(e, bb, [C, C], la, U, N), ab = AmCharts.line(e, cb, [C, C], la, U, N));
                                    Z = D - P;
                                    ka = new AmCharts.Cuboid(e, Z, H, y, w, va, Fa, N, la, U, V, s, m)
                                }
                            } else if (J = D - h / 2, K = M + N / 2, H = h, J + H > j && (H = j - J), 0 > J && (H += J, J = 0), Z = C - M, J < j && 0 < H) {
                                var ka = new AmCharts.Cuboid(e,
                                        H, Z, y, w, va, Ia, N, la, U, V, s, m),
                                    db, eb;
                                R > ja ? (db = [C, Ba], eb = [M, Aa]) : (db = [M, Ba], eb = [C, Aa]);
                                D < j && 0 < D && (Va = AmCharts.line(e, [D, D], db, la, U, N), ab = AmCharts.line(e, [D, D], eb, la, U, N))
                            }
                            ka && (oa = ka.set, ca.push(oa), oa.translate(J, K), z.url && oa.setAttr("cursor", "pointer"), Va && (ca.push(Va), ca.push(ab)), X = D, aa = C, qa = D, ra = C, Y || (z.x = m ? K + H / 2 : J + H / 2, this.animateColumns(ka, L, D, P, C, M), this.addListeners(oa, z)))
                        }
                        break;
                    case "ohlc":
                        if (!isNaN(ja) && !isNaN(Ta) && !isNaN(Ua) && !isNaN(R)) {
                            R < ja && (z.isNegative = !0, void 0 != ya && (na = ya));
                            var fb, gb,
                                hb;
                            if (m) {
                                var ib = C - h / 2,
                                    ib = AmCharts.fitToBounds(ib, 0, k),
                                    qb = AmCharts.fitToBounds(C, 0, k),
                                    jb = C + h / 2,
                                    jb = AmCharts.fitToBounds(jb, 0, k);
                                gb = AmCharts.line(e, [P, P], [ib, qb], na, U, N, ba);
                                0 < C && C < k && (fb = AmCharts.line(e, [Ra, Sa], [C, C], na, U, N, ba));
                                hb = AmCharts.line(e, [D, D], [qb, jb], na, U, N, ba)
                            } else {
                                var kb = D - h / 2,
                                ...
                                gb = AmCharts.line(e, [kb, rb], [M, M], na, U, N, ba);
                                0 < D && D < j && (fb = AmCharts.line(e, [D, D], [Aa, Ba], na, U, N, ba));
                                hb = AmCharts.line(e, [rb, lb], [C, C], na, U, N, ba)
                            }
                            ca.push(gb);
                            ca.push(fb);
                            ca.push(hb);
                ...
                if (!Y && !isNaN(R)) {
                    ...
                    if (this.end - this.start <= sb || 0 === sb) {
                        var Ca = this.createBullet(z, qa, ra, L);
                        Ca || (Ca = 0);
                        var tb = this.labelText;
                        if (tb) {
                            var da = this.createLabel(z, 0, 0, tb),
                                xa = 0,
                                Da = 0,
                                ub = da.getBBox(),
                                Wa = ub.width,
                            ...
                            switch (B) {
                                ...
                                case "right":
                                    ...
                                    break;
                                case "bottom":
                                    m && "column" == g ? (X = T, 0 > R ? (xa = -6, da.attr({
                                        "text-anchor": "end"
                                    })) : (xa = 6, da.attr({
                                        "text-anchor": "start"
                                    }))) : (Da = Ca / 2 + mb / 2, da.x = -(Wa / 2 + 2));
                                    break;
                                case "middle":
                                    "column" == g && (m ? (xa = -(D - P) / 2 - y, 0 > Z && (xa += y), Math.abs(D - P) < Wa && !this.showAllValueLabels && (da.remove(), da = null)) : (Da = -(C - M) / 2, 0 > Z && (Da -= w), Math.abs(C - M) < mb && !this.showAllValueLabels && (da.remove(), da = null)))
                            }
                            if (da) if (!isNaN(aa) && !isNaN(X)) if (X += xa, aa += Da, da.translate(X, aa), m) {
                                if (0 > aa || aa > k) da.remove(), da = null
                            } else {
                                var vb = 0;
                                "3d" == A && (vb = y * ea);
                                if (0 > X || X > j + vb) da.remove(), da = null
                            } else da.remove(), da = null
                        }
                        if ("column" == g && "regular" == A || "100%" == A) {
                            var wb = f.totalText;
                            if (wb) {
                                var Ka = this.createLabel(z, 0, 0, wb),
                                    xb = Ka.getBBox(),
                                    yb = xb.width,
                                    zb = xb.height,
                                    La, Ma, Ab = f.totals[L];
                                Ab && Ab.remove();
                                m ? (Ma = C, La = 0 > R ? D - yb / 2 - 2 : D + yb / 2 + 3) : (La = D, Ma = 0 > R ? C + zb / 2 : C - zb / 2 - 3);
                                Ka.translate(La, Ma);
                                f.totals[L] = Ka;
        ...
        if ("line" == g || "step" == g || "smoothedLine" == g) "smoothedLine" == g ? this.drawSmoothedGraph(q, r, ha, ia) : this.drawLineGraph(q, r, ha, ia), Y || this.launchAnimation()
    },
    ...
    drawLineGraph: function (a, b, d, e) {
        if (1 < a.length) {
            ...
            var k = this.lineAlpha,
                ...
                r = this.baseCoord,
                u = AmCharts.line(g,
                    a, b, this.lineColor, k, l, m, !1, !0);
            h.push(u);
            void 0 !== s && (k = AmCharts.line(g, a, b, s, k, l, m, !1, !0), j.push(k));
            if (0 < f && (k = a.join(";").split(";"), l = b.join(";").split(";"), "serial" == this.chartType && (0 < d.length ? (d.reverse(), e.reverse(), k = a.concat(d), l = b.concat(e)) : this.rotate ? (l.push(l[l.length - 1]), k.push(r), l.push(l[0]), k.push(r), l.push(l[0]), k.push(k[0])) : (k.push(k[k.length - 1]), l.push(r), k.push(k[0]), l.push(r), k.push(a[0]), l.push(l[0]))), a = AmCharts.polygon(g, k, l, n, f, 0, 0, 0, this.gradientRotation), h.push(a),
                p || void 0 !== s)) q || (q = f), p || (p = s), g = AmCharts.polygon(g, k, l, p, q, 0, 0, 0, this.gradientRotation), j.push(g);
            this.applyMask(j, h)
        }
    },
    ...
    drawSmoothedGraph: function (a, b, d, e) {
        if (1 < a.length) {
            ...
            if (0 < m && (l = a.join(";").split(";"), u = b.join(";").split(";"), k = "", 0 < d.length ? (d.reverse(), e.reverse(), l = a.concat(d), u = b.concat(e)) : (this.rotate ? (k += " L" + r + "," + b[b.length - 1], k += " L" + r + "," + b[0]) : (k += " L" + a[a.length - 1] + "," + r, k += " L" + a[0] + "," + r), k += " L" + a[0] + "," + b[0]), d = new AmCharts.Bezier(g, l, u, NaN,
                0, 0, n, m, f, k), h.push(d.path), p || void 0 !== s)) q || (q = m), p || (p = s), a = new AmCharts.Bezier(g, a, b, NaN, 0, 0, p, q, f, k), j.push(a.path);
            this.applyMask(j, h)
        }
    },
    ...
    animate: function (a) {
        ...
        b = b.startDuration;
        a && (this.rotate ? a.animateWidth(b, d) : a.animateHeight(b,
            d), a.set.show())
    },
    ...
    createBullet: function (a, b, d) {
        ...
        h = f = 0;
        if (this.customBullet || a.customBullet) l = this.customBullet, a.customBullet && (l = a.customBullet),
        ...
        if (j) {
            ...
            j && (this.bulletSet.push(j),
                j.translate(b, d), this.addListeners(j, a))
        }
        return g
    },
...
AmCharts.ChartCursor = AmCharts.Class({
    ...
    createCursor: function () {
        ...
        this.set.push(b);
        a ? (f && (h.pointerWidth = 0), "right" == e ? f ? h.setBounds(n, s + m, n + p + l, s + q + m) : h.setBounds(n + p + l + g, s + m, n + p + 1E3, s + q + m) : f ? h.setBounds(n, s, p + n, q + s) : h.setBounds(-1E3, -1E3, n - r - g,
            s + q + 15)) : (h.maxWidth = p, d.parseDates && (r = 0, h.pointerWidth = 0), "top" == e ? f ? h.setBounds(n + l, s + m, p + l + n, q + s) : h.setBounds(n + l, -1E3, p + l + n, s + m - r - g) : f ? h.setBounds(n, s, p + n, q + s - r) : h.setBounds(n, s + q + r + g - 1, n + p, s + q + r + g));
        this.hideCursor()
    },
    ...
    updateCursor: function (a, b) {
        ...
        if (this.enabled) {
            ...
            var g = d.categoryAxis,
                ...
                I = d.graphs,
                G = g.axisThickness;
            if (d.mouseIsOver || A || B || this.forceShow) if (this.forceShow = !1, B) {
                h = this.panClickPos;
                ...
                0 !== e && (h = {
                    type: "zoomed",
                    target: this
                }, h.chart = this.chart, g.parseDates && !g.equalSpacing ? (d + e > x && (e = x - d), A + e < v && (e = v - A), h.start = A + e, h.end = d + e,
                ...
                A && (q ? this.updateSelectionSize(NaN,
                ...
                if (I && this.valueBalloonsEnabled && v && d.balloon.enabled) {
                    ...
                    if (this.oneBalloonOnly) {
                        j = Infinity;
                        for (g = 0; g < I.length; g++) u = I[g], u.showBalloon && (!u.hidden && u.balloonText) && (t = s.axes[u.valueAxis.id].graphs[u.id], x = t.y, isNaN(x) || (q ? Math.abs(e - x) < j && (j = Math.abs(e - x), Y = u) : Math.abs(f - x) < j && (j = Math.abs(f - x), Y = u)))
                    }
                    for (g = 0; g < I.length; g++) if (u = I[g], !(this.oneBalloonOnly && u != Y) && (u.showBalloon && !u.hidden && u.balloonText) && (t = s.axes[u.valueAxis.id].graphs[u.id], x = t.y, !isNaN(x))) {
                        p = t.x;
                        r = !0;
                        if (q) {
                            if (j = x, 0 > p || p > n) r = !1
                        } else if (j = p, p = x, 0 > j || j > m + h) r = !1;
                        r && (r = u.valueBalloon, w = d.getBalloonColor(u, t), r.setBounds(k, l, k + m, l + n), r.pointerOrientation = "H", r.changeColor(w), void 0 !== u.balloonAlpha && (r.fillAlpha = u.balloonAlpha), void 0 !== u.balloonTextColor && (r.color = u.balloonTextColor), r.setPosition(j + k, p + l), u = d.formatString(u.balloonText, t, u), "" !== u && r.showBalloon(u), !q && r.set && r.set.hide(), v.push({
                            yy: x,
                            balloon: r
                        }))
                    }
                ...
                b ? (h = {
                    type: "changed"
                }, h.index = a, h.target = this, h.chart = this.chart, h.zooming = A, h.position = q ? f : e, h.target = this, d.fire("changed", h), this.fire("changed", h), this.skipZoomDispatch = !1) : (this.skipZoomDispatch = !0, d.updateLegendValues(a));
    ...
    handleMouseUp: function () {
        ...
        if (a) {
            ...
            if (this.drawingNow) {
                ...
                if (2 < Math.abs(b - d) || 2 < Math.abs(f - e)) b = {
                    type: "draw",
                    target: this,
                    chart: a,
                    initialX: b,
            ...
            if (this.enabled && 0 < this.data.length) {
                if (this.pan) this.rolledOver = !1;
                    ...
                    b.chart = this.chart;
                    if ("cursor" == this.type) this.rotate ? this.selectionPosY = a = e : this.selectionPosX = a = d, 2 > Math.abs(a - this.initialMouse) && this.fromIndex == this.index || (this.index < this.fromIndex ? (b.end = this.fromIndex,
                        b.start = this.index) : (b.end = this.index, b.start = this.fromIndex), a = this.chart.categoryAxis, a.parseDates && !a.equalSpacing && (b.start = this.data[b.start].time, b.end = this.data[b.end].time), this.skipZoomDispatch || this.fire(b.type, b));
                    else {
                        var g = this.initialMouseX,
                            h = this.initialMouseY;
                        if (!(3 > Math.abs(d - g) && 3 > Math.abs(e - h))) {
                            var f = Math.min(g, d),
                                j = Math.min(h, e),
                                d = Math.abs(g - d),
                                e = Math.abs(h - e);
                            a.hideXScrollbar && (f = 0, d = this.width);
                            a.hideYScrollbar && (j = 0, e = this.height);
                            b.selectionHeight = e;
                            b.selectionWidth = d;
                            b.selectionY = j;
                            b.selectionX = f;
                            this.skipZoomDispatch || this.fire(b.type, b)
                        }
                    }
                    AmCharts.remove(this.selection)
                }
...
AmCharts.ChartScrollbar = AmCharts.Class({
    ...
    draw: function () {
        ...
        if (l = a.graph) {
            ...
            for (p = 0; p < d.length; p++) {
                var q = d[p].axes[s.id].graphs[l.id].values,
                    r;
        ...
        if (this.skipEvent) this.skipEvent = !1;
            ...
            if (e.parseDates && !e.equalSpacing) {
                var a = a[0].time,
                    e = e.minDuration(),
                    h = Math.round(b / g) + a;
                this.dragging ? a = h + this.timeDifference : (a = Math.round((b + d) / g) + a, a = 6048E5 > Number(e) ? a - e : a - 864E5);
                h > a && (h = a);
                if (h != this.startTime || a != this.endTime) this.startTime = h, this.endTime = a, f.start = h, f.end = a, f.startDate = new Date(h), f.endDate = new Date(a), this.fire(f.type, f)
    ...
    zoomScrollbar: function () {
        ...
        var d = this.categoryAxis,
            e;
        d.parseDates && !d.equalSpacing ? (e = d.stepWidth, b = b[0].time, a = e * (this.startTime - b), b = e * (this.endTime - b), d = d.minDuration(), b = 6048E5 > Number(d) ? b + d * e : b + 864E5 * e) : (a = b[this.start].x[d.id],
            b = b[this.end].x[d.id], e = d.stepWidth, d.startOnAxis || (d = e / 2, a -= d, b += d));
        this.stepWidth = e;
...
AmCharts.wedge = function (a, b, d, e, f, g, h, j, k, l, m) {
    ...
    e = a.set();
    var I;
    p && (q = n(10 * q), t = n(10 * t), x = n(10 * x), w = n(10 * w), u = n(10 * u), v = n(10 * v), y = n(10 * y), r = n(10 * r), b = n(10 * b), k = n(10 * k), d = n(10 * d), g *= 10, h *= 10, j *= 10, s *= 10, 1 > Math.abs(f) && (1 >= Math.abs(x - t) && 1 >= Math.abs(y - v)) && (I = !0));
    f = "";
    if (0 < k) {
        p ? (path = " M" + q + "," + (u + k) + " L" + t + "," + (v + k), I || (path += " A" + (b - g) + "," + (k + d - h) + "," + (b + g) + "," + (k + d + h) + "," + t + "," + (v + k) + "," + x + "," + (y + k)), path += " L" + w + "," + (r + k), 0 < j && (I || (path += " B" + (b - j) + "," + (k + d - s) + "," + (b + j) + "," + (k + d + s) + "," + w + "," + (k + r) + "," + q + "," + (k + u)))) : (path = " M" + q + "," + (u + k) + " L" + t + "," + (v + k), path += " A" + g + "," + h + ",0," + B +
            ",1," + x + "," + (y + k) + " L" + w + "," + (r + k), 0 < j && (path += " A" + j + "," + s + ",0," + B + ",0," + q + "," + (u + k)));
        path += " Z";
        c = a.path(path, void 0, void 0, "1000,1000").attr(A);
        e.push(c);
        var G = a.path(" M" + q + "," + u + " L" + q + "," + (u + k) + " L" + t + "," + (v + k) + " L" + t + "," + v + " L" + q + "," + u + " Z", void 0, void 0, "1000,1000").attr(A);
        k = a.path(" M" + x + "," + y + " L" + x + "," + (y + k) + " L" + w + "," + (r + k) + " L" + w + "," + r + " L" + x + "," + y + " Z", void 0, void 0, "1000,1000").attr(A);
        e.push(G);
        e.push(k)
    }
    p ? (I || (f = " A" + n(b - g) + "," + n(d - h) + "," + n(b + g) + "," + n(d + h) + "," + n(t) + "," + n(v) + "," + n(x) + "," + n(y)), g = " M" + n(q) + "," + n(u) + " L" + n(t) + "," + n(v) + f + " L" + n(w) + "," + n(r)) : g = " M" + q + "," + u + " L" + t + "," + v + (" A" + g + "," + h + ",0," + B + ",1," + x + "," + y) + " L" + w + "," + r;
    0 < j && (p ? I || (g += " B" + (b - j) + "," + (d - s) + "," + (b + j) + "," + (d + s) + "," + w + "," + r + "," + q + "," + u) : g += " A" + j + "," + s + ",0," + B + ",0," + q + "," + u);
    ...
    drawChart: function () {
        ...
        if (AmCharts.ifArray(b)) {
            if (0 < a.realWidth && 0 < a.realHeight) {
                ...
                a.chartDataLabels = [];
                a.ticks = [];
                var n, s, p, q = AmCharts.toNumber(a.labelRadius),
                    r = a.measureMaxLabel();
...
AmCharts.AmDObject = AmCharts.Class({
    ...
    stop: function () {
        ...
        a && AmCharts.removeFromArray(this.R.animations,
            a);
